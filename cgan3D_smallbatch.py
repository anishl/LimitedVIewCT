...
from classifier3dcnn.model import ConvColumn5,ConvColumn3,ConvColumn7,ConvColumn9
import datautils
...
MODEL_NAME = 'generator_full_8v_ep_8x500x500'
lam = opt.lam
...
sub_blk_data_true,sub_blk_data_lv,train_ixs = datautils.load_small_batch_data(nData=(246//batch_size + 1)*batch_size,

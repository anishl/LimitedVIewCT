...
sub_blk_data_true,sub_blk_data_lv,train_ixs = datautils.load_small_batch_data(nData=(500000//batch_size + 1)*batch_size,
...
for epoch in range(opt.n_epochs):
    ...
    for batch_start_ix in np.arange(0,train_ixs.shape[0],batch_size):
        ...
        kbar.update(batch_start_ix, values=[("G loss", g_loss1.item())])

...
PATH = './saved_models/'
MODEL_NAME = 'generator_full_8v_ep_z4'
...
sio.savemat('results/'+MODEL_NAME+str(blck)+'_'+walnut_num+'.mat',{"data_true":data_true,"data_out_normalized":data_out_normalized,"data_lv":data_lv})
#%% Visualization
loadData=False
# loadData=True
...
if False:
    ...
    ax.set_title('Denoised (PWLS-OS) ', );ax.axis('off')
    cb = fig.colorbar(im,ax = ax,shrink = 2*0.5, format = '%0.0e')
    cb.ax.locator_params(nbins=1)
